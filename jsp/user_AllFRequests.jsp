    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li><a href="OSNServer_Login.jsp"><strong>Tweet Server </strong></a></li>
        </ul>
      </div>
      <div class="clr"></div>
      <div class="slider">
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p class="infopost">&nbsp;</p>
          <table width="624" height="257" border="2"  cellpadding="0" cellspacing="0"  style="border-collapse: collapse; margin:10px 0px 0px 10px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px;">
            <tr>
            ...
            <%
					...
					%>
            <tr>
              <td  width="160" height="194" align="center" valign="middle" style="color:#000000;">&nbsp;&nbsp;
                <div align="right">
                  <p align="center">
                    <input  name="image" type="image" src="images.jsp?imgid=<%=i%>" width="150" height="150" alt="Submit" />
                  </p>
              </div></td>
              <td  width="114" height="194" align="center" valign="middle"><span class="style23">&nbsp;&nbsp;
                </span>
                <div align="center" class="style23">
                  <%out.println(s1);%>
              </div>              </td>
              <td height="194" align="center"  valign="middle"><span class="style23">&nbsp;&nbsp;
                </span>
                <p class="style23">
                  <%out.println(s4);%>
              </p>              </td>
              ...
              <%
						...
						%>
              <td  width="74" valign="middle" height="194" style="color:#000000;"align="center"><a href="updatefrequest.jsp?rid=<%=j%>" class="style23">waiting               
              </a> </td>
              <%
						}
						...
						{
						%>
              <td  width="90" valign="middle" height="194" style="color:#000000;"align="center"><span class="style23">
                <%out.println(status);%>
              </span></td>
              <%
						}
						%>
			 <td  width="72" height="194" align="center" valign="middle"><span class="style23">&nbsp;&nbsp;
                </span>
			   <div align="center" class="style23">
                  <%out.println(dt);%>
              </div>              </td>
