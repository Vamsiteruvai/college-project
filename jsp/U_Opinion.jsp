...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="article">
        <h2 class="style16">Feed Opinion About Your Friend !!! </h2>
        <div class="clr"></div>
        <div class="post_content">
          <h2 align="center">&nbsp;</h2>
          <form id="form1" name="form1" method="post" action="U_Opinion1.jsp">
            <p>&nbsp;</p>
            <table width="361" border="0" align="center">
              <tr>
                <td width="169" bgcolor="#FF0000"><div align="center"><span class="style38">Opinion By </span></div></td>
              ...
              <tr>
                <td bgcolor="#FF0000"><div align="center"><span class="style38">Opinion For </span></div></td>
