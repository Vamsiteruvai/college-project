...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="article">
        <h2 class="style16">View All Rating Details !!! </h2>
        <p class="style16">&nbsp;</p>
        <div class="clr"></div>
        <div class="post_content">
          <h2 align="center">
            <table width="842" border="0" align="center">
              <tr>
                <td width="143" height="32" align="left" valign="bottom" bgcolor="#00FFFF"><div align="center" class="style21 style28">Rating From </div></td>
                <td width="155" align="left" valign="bottom" bgcolor="#00FFFF"><div align="center" class="style21 style28">Rated Details </div></td>
                <td width="126" align="left" valign="bottom" bgcolor="#00FFFF"><div align="center" class="style21 style28">Rated For</div></td>
                <td width="148" align="left" valign="bottom" bgcolor="#00FFFF"><div align="center" class="style21 style28">Rated Date and Time</div></td>
              </tr>
              <%
