...
<%@ page import ="java.text.SimpleDateFormat" %>
            ...
            <%
					...
					String filter=null,categorie=null,location1=null,sk=null,bin = "", paramname=null,fcat=null;
					...
					try {
						...
						while (params.hasMoreElements()) 
						{
							...
							if(paramname.equalsIgnoreCase("fcat"))
							{
								fcat=multi.getParameter(paramname);
						...
						FileInputStream fs1 = null;
			 			String query1="select * from filter  where filter='"+filter+"'  "; 
				...
				%>
			<p><a href="OSN_Server_Main.jsp" class="style8">Back</a></p>
				<%
				
					   }
					   else
					   {
					String strQuery2 = "insert into filter(fcat,filter) values('"+fcat+"','"+filter+"')";
      ...
      <a href="OSN_Server_Main.jsp" class="style22"></a></div>
  </div>
  <div class="fbg">
