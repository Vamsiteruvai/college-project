...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="text">
        <h1 class="style20">Trust Assessment in Online Social Networks</h1>
      </div>
      <div class="menu_nav">
        <ul>
...
%>
            ...
            <table width="342"  border="2" align="center"  cellpadding="0" cellspacing="0">
              <tr>
                <td align="center" bgcolor="#FF0000"><div align="center" class="style25"><strong><span class="style22">User Image </span></strong></div></td>
                <td><div align="center">
                  <input  name="image2" type="image" src="images.jsp?imgid=<%=i%>" width="100" height="100" alt="Submit" />
                </div></td>
              </tr>
              <tr>
                <td height="40" align="center" bgcolor="#FF0000"><div align="center" class="style25"><strong><span class="style22">User Name</span></strong></div></td>
                <td><div align="center" class="style23"><%=s2%></div></td>
              </tr>
              <tr>
                <td height="40" align="center" bgcolor="#FF0000"><div align="center" class="style25"><strong><span class="style22">E-Mail</span></strong></div></td>
                <td><div align="center" class="style23"><%=s4%></div></td>
              </tr>
              <tr>
                <td height="40" align="center" bgcolor="#FF0000"><div align="center" class="style25"><strong><span class="style22">Mobile</span></strong></div></td>
                <td><div align="center" class="style23"><%=s5%></div></td>
              </tr>
              <tr>
                <td height="40" align="center" bgcolor="#FF0000"><div align="center" class="style25"><strong><span class="style22">Address</span></strong></div></td>
                <td><div align="center" class="style23"><%=s6%></div></td>
              </tr>
              <tr>
                <td height="40" align="center" bgcolor="#FF0000"><div align="center" class="style25"><strong><span class="style22">DOB</span></strong></div></td>
                <td><div align="center" class="style23"><%=s7%></div></td>
              </tr>
              <tr>
                <td height="40" align="center" bgcolor="#FF0000">&nbsp;</td>
