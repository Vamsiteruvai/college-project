...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="text">
        <h1 class="style31 style32">Trust Assessment in Online Social Networks</h1>
      </div>
      <div class="menu_nav">
        <ul>
          <li><a href="index.html"><span>Home</span></a></li>
          <li class="active"><a href="UserLogin.jsp"><span>User</span></a></li>
          <li><a href="OSNServer_Login.jsp"><span>OSN Server </span></a></li>
        </ul>
      </div>
      <div class="clr"></div>
      <div class="slider">
		 ...
		 try
				{
					...
					int totalrank=rank+1;
										
										String q2="Update ttopic set rank='"+totalrank+"' where tname='"+tname+"'";
		 ...
		 %>
            ...
            <table width="600" border="2" align="center" cellpadding="1" cellspacing="1" >
              <tr >
                ...
                <td width="227" height="36" align="left" bgcolor="#FF0000" ><div align="center" class="style33">Tweet Name </div></td>
                <td bgcolor="#FF0000"><div align="center" class="style28"><%= tname%></div></td>
              </tr>
              <tr>
                <td width="227" height="30" align="left" bgcolor="#FF0000" ><div align="center" class="style33">Created By  </div></td>
                <td bgcolor="#FF0000"><div align="center" class="style28"><%= tuser%></div></td>
              </tr>
              <tr>
                <td width="227" height="33" align="left" bgcolor="#FF0000" ><div align="center" class="style33">Date </div></td>
                <td bgcolor="#FF0000"><div align="center" class="style27"><%= dt%></div></td>
              </tr>
			 <tr>
			  <td height="37" align="left" bgcolor="#FF0000"><div align="center" class="style33">Description </div></td>
			  <td bgcolor="#FF0000"><div align="center" class="style27"><%= desc%></div></td>
			 </tr>
  
  <tr>
    <td width="227" height="29" align="left" bgcolor="#FF0000"><div align="center" class="style33">Rank</div></td>
    <td bgcolor="#FF0000"><div align="center" class="style27"><%= totalrank%></div></td>
  </tr>
  <tr> </tr>
		...
		%>
		  <tr>
    <td  width="158" height="50" align="center" valign="middle" bgcolor="#FFFFFF" style="color: #2c83b0;"><div align="left " class="style8 style15 style11 style29" style="margin-left:20px;">
      <div align="center" class="style30">Tweet By</div>
    </div></td>
    <td  width="227" height="50" align="center" valign="middle" bgcolor="#FFFFFF" style="color: #2c83b0;" columnspan="2"><div align="left " class="style8 style15 style11 style29" style="margin-left:20px;">
      <div align="center" class="style30">Tweet  Details</div>
    </div></td>
    <td  width="195" height="50" align="center" valign="middle" bgcolor="#FFFFFF" style="color: #2c83b0;" columnspan="2"><div align="left " class="style8 style15 style11 style29" style="margin-left:20px;">
	...
	while ( rs1.next() )
	   {
		 ...
		 %>
           <tr>
            ...
            <a href="UserMain.jsp" class="style35">Back</a></div>
      </div>
