...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="article">
        <h2 class="style16">View All Un Trust Assessment Details !!! </h2>
        <p class="style16">&nbsp;</p>
        <div class="clr"></div>
          ...
          <h2 align="center">
            <table width="842" border="0" align="center">
              <tr>
                ...
                <td width="155" align="left" valign="bottom" bgcolor="#FF0000"><div align="center" class="style28 style21"><strong>Opinions Details </strong></div></td>
    ...
    try 
	{
				...
				while ( rs.next() )
			   {
								...
								s1=rs.getString(1);
								s2=rs.getString(2).toLowerCase(); // opinion
								s3=rs.getString(3);
								s4=rs.getString(4);	
			       ...
			       String sql1="select * from filter where fcat='"+assesment+"' ";
                ...
                <td align="center" valign="middle" bgcolor="#FF0000"><div align="center" class="style28 style22"><strong><%=s2%></strong></div></td>
