...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="article">
        <h2 class="style16">View User <span class="style20 style22"><span class="style35"><%=((String)application.getAttribute("uname"))%></span></span>  Friends. </h2>
        <div class="clr"></div>
        <div class="post_content">
          <h2 align="center">
            <table width="962" border="1" align="center">
              <tr>
                <td width="160" height="32" valign="bottom" bgcolor="#FF0000"><div align="center" class="style27 style28 style36">User Image </div></td>
                <td width="147" valign="bottom" bgcolor="#FF0000"><div align="center" class="style27 style28 style36">User Name </div></td>
                <td width="157" valign="bottom" bgcolor="#FF0000"><div align="center" class="style27 style28 style36">Mobile</div></td>
                <td width="144" valign="bottom" bgcolor="#FF0000"><div align="center" class="style27 style28 style36">E-Mail</div></td>
                <td width="157" valign="bottom" bgcolor="#FF0000"><div align="center" class="style27 style28 style36">Address</div></td>
                <td width="157" valign="bottom" bgcolor="#FF0000"><div align="center" class="style27 style36 style28">DOB</div></td>
				<td width="157" valign="bottom" bgcolor="#FF0000"><div align="center" class="style27 style36 style28">Feed Opinion</div></td>
				<td width="157" valign="bottom" bgcolor="#FF0000"><div align="center" class="style27 style36 style28">Feed Trust Rate</div></td>
													...
													uuu = rs1.getString(3);
																...
																if( rs2.next() )
																{
																	...
																	%><tr>
																		...
																		<td align="center" valign="middle"><div align="center" class="style33"><a href="U_Opinion.jsp?uname=<%=uuu%>">Opinion</a></div></td>
																	    <td align="center" valign="middle"><div align="center" class="style33"><a href="U_Rate.jsp?uname=<%=uuu%>">Rate</a></div></td>
																	 </tr><%
																}	
