    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="style18"><a href="OSNServer_Login.jsp"><strong>OSN Server </strong></a></li>
        </ul>
      </div>
      	...
      	try 
	{
        %>
              ...
              <table width="308" border="2" align="center"  cellpadding="0" cellspacing="0">
                <tr>
                  <td width="162" height="30" bgcolor="#FF0000"><div align="center" class="style25 style30">Profile Photo</div></td>
                  <td width="142" bgcolor="#FF0000"><div align="center" class="style25 style30">User Name </div></td>
                </tr>
                <%	
